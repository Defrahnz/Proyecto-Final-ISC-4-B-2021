 ...
 * @author lapiz
 */
public class DatosA extends javax.swing.JFrame {

    /**
     * Creates new form DatosA
     */
    public DatosA() {
        initComponents();
    }
    ...
    public void paint (Graphics g){
      ...
      g2d.drawRoundRect(44, 50, 350, 50, 10, 10);
      //Circulo
      g2d.setColor(Color.RED);
      g2d.drawOval(400, 50, 50, 50);
      //Escrito
      g2d.setColor(Color.ORANGE);
      g2d.setFont(new Font ("ARIAL",PLAIN,20));
      g2d.drawString("'Tu seguridad es nuestra prioridad'", 60,80);
      g2d.drawString("HC", 412,80);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 400, 170, 50));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/logo mini amarillo.png"))); // NOI18N
        jLabel10.setText("jLabel10");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 90, -1));

        jLabel2.setFont(new java.awt.Font("Baskerville Old Face", 1, 18)); // NOI18N
        jLabel2.setText("Universidad Autonoma de Aguascalientes");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, -1, -1));

        jLabel4.setFont(new java.awt.Font("Baskerville Old Face", 1, 18)); // NOI18N
        jLabel4.setText("Profesora: Georgina Salazar Partida");
        ...
        jLabel7.setText("Aldo Perez Reynoso");
        ...
        jLabel9.setText("Oliver Olaf Martinez Gonzalez");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, -1, -1));

        jLabel1.setFont(new java.awt.Font("Baskerville Old Face", 1, 18)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondoUAA.jpg"))); // NOI18N
  ...
  Inicio gal=new Inicio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatosA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
